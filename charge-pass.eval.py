    ...
    data=lambda: [
        {
            ...
            "expected": "We accept Visa, MasterCard, American Express, Discover, PayPal, Apple Pay, Google Pay, and Shop Pay. All transactions are processed over encrypted SSL connections. Payment is charged when the order ships. Payment plans through Affirm are available on orders over $500, subject to approval.",
        }
    ],
    task=task,
    scores=[ships_scorer],
